...
public class StrUtil {
    ...
    public static long ipStr2Long(String ip) {
        String[] ips = ip.split("\\.");
        return StrUtil.parseLong(ips[0]) * 256 * 256 * 256
                + StrUtil.parseLong(ips[1]) * 256 * 256
     ...
     * create by yangwm in Nov 4, 2008
     * 8:52:57 PM
     * 
     * @param str1
     * @param str2
...
//    }
	...
	public static String getParamValue(String key, String value, String mark) {
		...
		if (mark.indexOf(key) == -1) {
			...
			if (value.indexOf(",") != -1) {
				...
				for (int i = 0; i < valueArry.length; i++) {
					String valuex = valueArry[i];
					int n = i + 1;
					
					if (i == 0) {
						result.append("\"").append(key + "." + n).append("\"")
						.append(":");
						result.append("\"").append(valuex).append("\"");
					} else {
						result.append(",").append("\"").append(key + "." + n).append("\"")
						.append(":");
						result.append("\"").append(valuex).append("\"");
					}
				}
				...
				result.append("\"").append(key).append(".1").append("\"").append(":");
				result.append("\"").append(value).append("\"");
				return result.toString();
			}
		}
...
//        System.out
//                .println("------------test nullToEmptyString and nullStringToEmptyString ------------");
...
//        // test equate
//        System.out
//                .println("------------test equate and equalsIgnoreCase ------------");
...
//    	System.out.println(getParamValue("volumes","kkk,eee,tttt"));
    }
}
